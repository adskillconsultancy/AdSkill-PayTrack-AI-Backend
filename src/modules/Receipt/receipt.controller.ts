...
const createReceipt = catchAsync(async (req: Request, res: Response) => { const data = await ReceiptService.createReceipt(req.params.paymentId, req.user!.id, req.user?.role); sendResponse(res, { statusCode: httpStatus.CREATED, success: true, message: "Receipt generated successfully", data }); });
